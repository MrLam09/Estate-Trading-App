    ...
    return (
        <section className="flex min-h-screen overflow-hidden md:bg-gray-100">
            ...
            <div className="flex flex-col justify-between flex-grow text-gray-500 bg-gray-800">
                ...
                <Link to="/Dashboard/add-new-ets-inf" className="inline-flex items-center justify-center py-3 rounded-lg hover:text-gray-400 hover:bg-gray-700 focus:text-gray-400 focus:bg-gray-700">
                    <span className="sr-only">Thêm BĐS</span>
                    <HiViewGridAdd className="w-6 h-6"/>
                </Link>
                <Link to="/Dashboard/manager-ets-infs" className="inline-flex items-center justify-center py-3 rounded-lg hover:text-gray-400 hover:bg-gray-700 focus:text-gray-400 focus:bg-gray-700">
            ...
            <main className="p-6 space-y-6 sm:p-10 ">
                ...
                <div className="mr-6">
                    ...
                    <h2 className="text-gray-600 ml-0.5">Admin route</h2>
                </div>
                <div className="flex flex-col items-start justify-end -mb-3 md:flex-row">
                    <Link to="/dashboard/manager-ets-infs" className="inline-flex px-5 py-3 mb-3 text-purple-600 border border-purple-600 rounded-md hover:text-purple-700 focus:text-purple-700 hover:bg-purple-100 focus:bg-purple-100">
                    <svg aria-hidden="true" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="flex-shrink-0 h-5 w-5 -ml-1 mt-0.5 mr-2">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" />
                    </svg>
                    Quản lý BĐS
                    </Link>
                    <Link to="/dashboard/add-new-ets-inf" className="inline-flex px-5 py-3 mb-3 ml-6 text-white bg-purple-600 rounded-md hover:bg-purple-700 focus:bg-purple-700">
