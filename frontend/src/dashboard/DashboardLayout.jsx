...
const DashboardLayout = () => {
    ...
    return (
            ...
            <div className="flex-grow flex flex-col justify-between text-gray-500 bg-gray-800">
                ...
                <Link to="/Dashboard/add-new-ets-inf" className="inline-flex items-center justify-center py-3 hover:text-gray-400 hover:bg-gray-700 focus:text-gray-400 focus:bg-gray-700 rounded-lg">
                    <span className="sr-only">Add Book</span>
                    <HiViewGridAdd className="h-6 w-6"/>
                </Link>
                <Link to="/Dashboard/manager-ets-infs" className="inline-flex items-center justify-center py-3 hover:text-gray-400 hover:bg-gray-700 focus:text-gray-400 focus:bg-gray-700 rounded-lg">
